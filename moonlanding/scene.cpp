    ...
    currentNode_(nullptr)
{
    ...
    auto disp   = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/DISP.png").mirrored());
    auto bumps  = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/NRM.png").mirrored());
    */
    ...
    meshes_["Duck"]    = std::make_shared<Mesh>(":/assets/models/trefoil.obj", std);
    ...
    meshes_["Sphere"] = std::make_shared<Mesh>(make_shared<geom::Planet>(400,400), std);
