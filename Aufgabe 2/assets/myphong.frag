...
vec3 phongIllum(vec3 normalDir, vec3 viewDir, vec3 lightDir)
{
    ...
    // ambient part
    vec3 ambient = vec3(1);//k_ambient * ambientLightColor;
    ...
    vec3 diffuse = vec3(1);//k_diffuse * lightColor * ndotl;
    ...
    vec3 specular =  ver3(1);//k_specular * lightColor * pow(rdotv, shininess);
