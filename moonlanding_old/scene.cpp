    ...
    currentNode_(nullptr)
{
    ...
    // load textures
    auto day    = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/COLOR.png").mirrored());
    auto night  = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/COLOR.png").mirrored());
    auto gloss  = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/COLOR.png").mirrored());
    auto clouds = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/COLOR.png").mirrored());
    auto disp   = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/COLOR.png").mirrored());
    auto bumps  = std::make_shared<QOpenGLTexture>(QImage(":/assets/textures/moon/COLOR.png").mirrored());
    ...
    nodes_["Universe"] = createNode(nullptr, false);
    nodes_["Universe"]->children.push_back(nodes_["Moon"]);
    nodes_["Universe"]->children.push_back(nodes_["Cube"]);
